import 'package:firstjob/sharedComponents/pops/dialog_screen19.dart';
import 'package:flutter/material.dart';
import 'package:step_progress_indicator/step_progress_indicator.dart';

import '../../screens/reusable_components.dart';
class DialogScreen18 extends StatelessWidget {
  const DialogScreen18({Key? key}) : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children:  [
              ...
              const SizedBox(height: 10,),
              const Text('مهلة الدفع', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold,color: Color.fromRGBO(0, 0, 0, 70)),),
              const SizedBox(height: 15,),
              ...
              GestureDetector(
                onTap: (){
                  showDialog(
                      context: context,
                      builder: (BuildContext context)=>const DialogScreen19());
                ...
                child: Container(
                  ...
                  child: const Center(child: Text('موافق', style: TextStyle(fontWeight: FontWeight.bold),)),
                ),
              )
